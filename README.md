...
del generador de planos de fundaciones (T001): mismos 8 graphs, mismo contrato de
nombres, sin pasos extra en Dynamo Player.
...
- **05 (tags)** solo acepta plantas de Armaduras: una planta de Formas seleccionada por
  error se ignora con aviso, sin ensuciarla.
